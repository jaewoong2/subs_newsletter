...
const BlockCards = async () => {
  ...
  return (
    ...
    <div className='flex h-full w-full max-w-6xl flex-col items-center justify-center gap-4 p-10 max-md:p-5'>
      <div className='grid h-full w-full grid-cols-[4fr_3fr] gap-x-3 gap-y-5 overflow-hidden max-md:grid-cols-1'>
