...
const ThemeToogleButton = () => {
  ...
  return (
    <div
      className='btn-sqare btn-ghost btn aspect-square'
      onClick={(e) => {
        if (e.currentTarget === e.target) {
          onClickToogleIcon(resolvedTheme === 'light' ? 'dark' : 'light')
        }
      }}
    >
      <label className='swap' aria-label='다크모드 토글'>
        ...
        <input
          ...
          onChange={() => onClickToogleIcon(resolvedTheme === 'light' ? 'dark' : 'light')}
        />
        {/* sun icon */}
