  ...
  return (
    <div className='flex h-full w-full flex-col items-center py-10'>
      ...
      <div className='font-tossFace'>
        <span className='font-tossFace text-lg font-bold'>{name}</span> 님 안녕하세요 😀
      </div>
      ...
      <div className='flex flex-col items-center justify-center'>
        <div className='font-tossFace'>
          <span className='font-tossFace text-lg font-bold'>{name}</span>님, 뉴스레터 추천 서비스인 뉴섭에 등록 해주셔서
          감사해요
        </div>
        <span className='py-4 font-tossFace text-2xl'>🩷</span>
      </div>
      <div className='font-tossFace'>성장하는 뉴섭이 되도록 하겠습니다. 지켜봐주세요 🫡</div>
    </div>
  )
}

export default ActivedPage
